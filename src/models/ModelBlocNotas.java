 ...
 */
    ...
    public int getCriptacion() {
        return criptacion;
    }

    public void setCriptacion(int criptacion) {
        this.criptacion = criptacion;
    }
/**
 ...
 */
    ...
    public void encriptar(){
        ...
        for (int i = 0; i < cadena.length; i++){
            cadena[i] = (char)(cadena [i] + (char)criptacion);
        }
